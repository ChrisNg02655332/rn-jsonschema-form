...
function ArrayFieldTitle({ TitleField, idSchema, title, required }: any) {
...
function DefaultNormalArrayFieldTemplate(props: any) {
  return (
    <View style={props.style} nativeID={props.idSchema.$id}>
      <ArrayFieldTitle
...
function isItemRequired(itemSchema: any) {
